...
var SDK = /** @class */ (function () {
    function SDK() {
        ...
        this.core = new core_1.default(this.spec, 'chainabuse/0.1.0 (api/6.1.3)');
    }
    /**
     ...
     */
    SDK.prototype.reports = function (metadata) {
     ...
     */
    SDK.prototype.report = function (metadata) {
        return this.core.fetch('/reports/{reportId}', 'get', metadata);
    };
    /**
     ...
     */
    SDK.prototype.createReports = function (body) {
        return this.core.fetch('/reports/batch', 'post', body);
    };
    /**
     ...
     */
    SDK.prototype.checkSanctionedAddress = function (metadata) {
        return this.core.fetch('/sanctioned-addresses/{address}', 'get', metadata);
    };
    return SDK;
}());
